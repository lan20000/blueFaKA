<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"C:\phpStudy\PHPTutorial\WWW/APP/index\view\index\trade.html";i:1564019567;s:52:"C:\phpStudy\PHPTutorial\WWW/APP/index\view\base.html";i:1563966804;}*/ ?>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="layui-col-xs12 layui-col-md4">
					<div class="layui-field-box">
						...
						<fieldset class="layui-elem-field">
								...
								<div class="layui-field-box">
									会员尊享价格：<span class="trade-price">¥<?php echo $goodinfo['dailiprice']; ?></span>
								</div>
						</fieldset>
						<?php endif; ?>
					</div>
				...
				<div class="layui-col-xs12 layui-col-md8">
					<div class="layui-field-box">
						...
						<p class="trade-goodinfo">
								...
								<span class="trade-price">¥<?php echo $goodinfo['dailiprice']; ?></span>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								...
								<select name="type" <?php echo $isdaili; ?>>
									<?php if($isdaili): ?>
										...
										<?php endif; else: if(($siteinfo['alipay'] == 1)): ?>
										<option value="alipay" selected="">支付宝</option>
										<?php endif; if(($siteinfo['wxpay'] == 1)): ?>
										<option value="wxpay">微信</option>
										<?php endif; if(($siteinfo['qqpay'] == 1)): ?>
										<option value="qqpay">QQ钱包</option><?php endif; endif; ?>
								</select>
							</div>
						</div>
						<div  
