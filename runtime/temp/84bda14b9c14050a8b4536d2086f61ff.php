<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"C:\phpStudy\PHPTutorial\WWW/APP/index\view\index\index.html";i:1563881414;s:52:"C:\phpStudy\PHPTutorial\WWW/APP/index\view\base.html";i:1563966804;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div style="background-color: #fff;">
            ...
            <ul class="goods_screen">
                ...
                <?php if($siteinfo['indexmode'] == '1'): foreach($res2 as  $key =>$cat): ?>
                    <li data-type="<?php echo $key; ?>" onclick="goodsScreen(<?php echo $key; ?>+1,this,<?php echo $cat['id']; ?>)">
                        <?php echo $cat['name']; ?>
                    </li>
