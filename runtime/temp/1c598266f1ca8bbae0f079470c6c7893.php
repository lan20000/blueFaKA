<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"C:\phpStudy\PHPTutorial\WWW/APP/daili\view\index\payload.html";i:1564045080;}*/ ?>
<html>
...
<![endif]-->
	...
	<style>
		body {
			...
			background-image: url(//cn.bing.com/az/hprichbg/rb/PenaNationalPalace_ZH-CN12058841312_1920x1080.jpg);
...
<body class="ie8" style="">
	<div class="main">
		<form name="formName" id="formName" action="/index/index/pay">
			<input name="money" type="text" value="<?php echo $chongdata['summoney']; ?>" hidden>
			<input name="email" type="text" value="<?php echo $chongdata['email']; ?>" hidden>
			<input name="type" type="text" value="<?php echo $chongdata['name']; ?>" hidden>
			<input name="paytype" type="text" value="<?php echo $chongdata['paytype']; ?>" hidden>
			...
			<div id="js-alert-box" class="alert-box" style="display:block">
				<svg class="alert-circle" width="234" height="234">
					...
					<circle id="js-sec-circle" class="alert-sec-circle" cx="117" cy="117" r="108" fill="transparent"
						...
						style="stroke-dashoffset:-514px"></circle><text class="alert-sec-unit" x="100" y="172"
						fill="#BDBDBD">秒</text>
				</svg>
				...
				<div class="alert-body">
					...
					<button type="submit" id="js-alert-btn" class="alert-btn">立即前往</button>
				</div>
	...
	<script type="text/javascript">
		...
		function alertSet(e) {
			...
			setTimeout(function(){
				...
				var form = document.getElementById('js-alert-btn');
				form.disabled = true;
			},970)
		} 
	</script>
	<script>alertSet("支付验证中...");</script>
</body>
